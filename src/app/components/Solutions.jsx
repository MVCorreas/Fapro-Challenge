    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-8">
        <div className="flex flex-col justify-center items-start">
          <h2 className="text-5xl sm:text-5xl lg:text-7xl font-200 lg:leading-normal  text-medium-pink">
            SOLUTIONS
          </h2>
          <div className="p-6">
            <h3 className="text-2xl font-bold text-dark-pink">
              {solutions[0].title}
            </h3>
        ...
        <div className="grid grid-cols-1 gap-8">
          {solutions.slice(1).map((sol) => (
            <div key={sol.id} className="p-6">
              <h3 className="text-2xl font-bold text-dark-pink">{sol.title}</h3>
